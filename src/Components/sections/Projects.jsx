            ...
            <div className={"Container mx-auto max-w-5xl"}>
                ...
                <div className={"grid grid-cols-1 md:grid-cols-2 gap-4"}>
                    {projects.map((project) => (
                        <div key={project.name} className={cn("card-hover w-80 h-5xl dark:border-zinc-100 dark:border-zinc-600 border-1")}>
                            ...
                            <div className={ "flex flex-end justify-center mb-4 mb-6"}>
